...
- **Página de Sedes (`/centers`)**: Página completa e independiente estructurada en subcomponentes locales modulares (`CentersHero.jsx`, `CentersPellegrini.jsx`, `CentersLavalle.jsx`, `CentersFacilities.jsx`) con un diseño altamente responsivo. Detalla los centros activos, exponiendo en la Sede Pellegrini la dirección y horarios oficiales de atención (`Lunes a Viernes 9:00 a 18:00hs`) acompañados de iconos informativos, listado de especialidades y estudios diagnósticos adaptados para su correcta lectura en móviles. Incluye desplazamiento por anclas, geolocalización real conectada a Google Maps, un coordinador inteligente de redirección y scroll suave (*scroll-to*) para anclas externas e internas, y la sección final de "Instalaciones" (`CentersFacilities.jsx`) que integra tecnología de vanguardia, ocultando elementos visuales pesados en dispositivos móviles para optimizar la experiencia de navegación.
- **Página de Nosotros (`/about`)**: Página completa e independiente estructurada en subcomponentes locales modulares (`AboutHero.jsx`, `AboutFacilities.jsx`, `AboutWhyChooseUs.jsx`, `AboutProfessionals.jsx`) que describe la identidad corporativa de ODUS con layouts optimizados para pantallas pequeñas. Ofrece una sección de Quiénes Somos (con un enfoque profesional y auténtico que detalla la transición de clínica dental a centro ambulatorio integral), un bloque de Instalaciones clínicas, la sección de Por Qué Elegirnos, y una grilla de Nuestros Profesionales con avatares armonizados y de tamaño consistente en su versión móvil.

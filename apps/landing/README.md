...
- **Página de Nosotros (`/about`)**: Página completa e independiente estructurada en subcomponentes locales modulares (`AboutHero.jsx`, `AboutFacilities.jsx`, `AboutWhyChooseUs.jsx`) que describe la identidad corporativa de ODUS. Ofrece una sección de Quiénes Somos (con un enfoque profesional y auténtico que detalla la transición de clínica dental a centro ambulatorio integral), un bloque de Instalaciones clínicas y la sección de Por Qué Elegirnos.

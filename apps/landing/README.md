...
- `components/`: Componentes modulares y reutilizables globales de la aplicación (ej. `Header.jsx`, `MobileNav.jsx`, `Hero.jsx`, `Specialties.jsx`, `SpecialtyModal.jsx`, `Centers.jsx`, `Institutional.jsx`, `Circuit.jsx`).

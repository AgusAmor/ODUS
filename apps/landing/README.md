...
- **Página de Especialidades (`/specialties`)**: Página específica estructurada en componentes modulares. Cuenta con secciones de Hero con badges de excelencia, filas alternadas con iconos circulares clínicos para especialidades clave y el flujo del "Circuito de Salud" en 3 pasos.
- **Página de Sedes (`/centers`)**: Página completa e independiente estructurada en subcomponentes locales modulares (`CentersHero.jsx`, `CentersPellegrini.jsx`, `CentersLavalle.jsx`, `CentersFacilities.jsx`). Detalla los centros activos, exponiendo en la Sede Pellegrini la dirección y horarios oficiales de atención (`Lunes a Viernes 9:00 a 18:00hs`) acompañados de iconos informativos, listado de especialidades y estudios diagnósticos que señalan las próximas incorporaciones de servicios (como Densitometría con su badge `"Próximamente"` sin desajustes de línea). Incluye desplazamiento por anclas, geolocalización real conectada a Google Maps, un coordinador inteligente de redirección y scroll suave (*scroll-to*) para anclas externas e internas, y la sección final de "Instalaciones" (`CentersFacilities.jsx`) que integra la tecnología de vanguardia.
...
- `app/specialties/components/`: Componentes específicos y exclusivos de la sección de especialidades (`SpecialtiesHero.jsx`, `SpecialtiesEditorial.jsx`, `SpecialtiesCircuit.jsx`).

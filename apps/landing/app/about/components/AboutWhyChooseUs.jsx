...
export default function AboutWhyChooseUs({ chooseRef, chooseRevealed }) {
  return (
    <section
      ref={chooseRef}
      className="flex flex-col items-center text-center gap-12 pt-8"
    >
      {/* Centered Heading */}
      <div
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-5xl mx-auto items-stretch">
        ...
        <div
          className={`bg-linear-to-b from-primary/95 to-primary text-white p-8 rounded-3xl shadow-md hover:-translate-y-2 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center gap-6 group reveal-fade-up transition-delay-75 ${chooseRevealed ? "revealed" : ""}`}
        >
        ...
        <div
          className={`bg-white border border-neutral/10 text-primary p-8 rounded-3xl shadow-[0_8px_24px_rgba(11,59,140,0.01)] hover:-translate-y-2 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center gap-6 group reveal-fade-up transition-delay-150 ${chooseRevealed ? "revealed" : ""}`}
        >
        ...
        <div
          className={`bg-linear-to-b from-[#184293] to-[#0f2d66] text-white p-8 rounded-3xl shadow-md hover:-translate-y-2 hover:shadow-lg transition-all duration-300 flex flex-col items-center text-center gap-6 group reveal-fade-up transition-delay-225 ${chooseRevealed ? "revealed" : ""}`}
        >
          <div className="w-16 h-16 rounded-full bg-white/10 flex items-center justify-center text-secondary shrink-0 group-hover:scale-110 transition-transform duration-300">

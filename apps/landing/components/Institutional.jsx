          ...
          >
            {values.map((val, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className={`bg-white border border-neutral/10 p-6 rounded-3xl shadow-[0_4px_12px_rgba(11,59,140,0.01)] flex flex-col gap-5 transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_16px_32px_rgba(11,59,140,0.04)] group reveal-fade-up ${delayClass} ${valuesGridRevealed ? "revealed" : ""}`}
                >

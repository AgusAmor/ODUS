...
export default function Centers() {
  ...
  return (
    <section
      className="py-section-gap max-w-container-max-width mx-auto px-margin-mobile md:px-margin-desktop flex flex-col gap-12 md:gap-16"
      id="sedes"
    >
      <div
        ref={titleRef}
        className={`text-center md:text-left mb-2 reveal-fade-up ${titleRevealed ? "revealed" : ""}`}
      >
      ...
      <div
        ref={pellegriniRef}
        className={`flex flex-col lg:flex-row gap-8 lg:gap-16 items-center bg-white rounded-4xl p-6 lg:p-12 border border-neutral/10 shadow-[0_8px_30px_rgb(11,59,140,0.02)] reveal-fade-up ${pellegriniRevealed ? "revealed" : ""}`}
      >

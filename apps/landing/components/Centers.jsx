...
export default function Centers() {
  ...
  return (
    <section className="bg-tertiary/50 py-12 md:py-16" id="sedes">
      <div className="max-w-container-max-width mx-auto px-margin-mobile md:px-margin-desktop flex flex-col gap-6 md:gap-8">
        <div
          ref={titleRef}
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8 relative z-10">
              <div className="flex flex-col gap-4 max-w-xl">
                ...
                <p className="font-body-md text-body-md text-neutral">
                  Estamos trabajando en la expansión de nuestros servicios. La
                  Sede Lavalle será inaugurada próximamente, ampliando nuestra
                  capacidad para brindarte más especialidades y comodidad.
                </p>
              </div>
